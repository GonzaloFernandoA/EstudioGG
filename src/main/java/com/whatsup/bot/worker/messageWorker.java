...
public class messageWorker {
    ...
    public void ejecutarTareaAsincrona() {
        ...
        Map<String, String> dataMap = PathUtils.readFilesToMap(config.getOut());
        for (Map.Entry<String, String> entry : dataMap.entrySet()) {
            ...
            PathUtils.move(new File(config.getOut() + firstKey + ".json"), config.getOut() + "sent/" + firstKey + ".json." + DateTimeUtils.getDateTime());
